...
void TrimOcclusion(const Vector2f& loc,
  ...
  const bool occlusion0 =
      rayOcclusion0 && (trim_line.Touches(loc) || trim_line.Touches(l1_p0) ||
                        !trim_line.Intersects(loc, l1_p0));

  // test_line.p1 is in front of, and occludes trim_line.
  const bool occlusion1 =
      rayOcclusion1 && (trim_line.Touches(loc) || trim_line.Touches(l1_p1) ||
